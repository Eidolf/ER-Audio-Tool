...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "btn_recheck_readiness": "Recheck Readiness",
        "btn_test_capture": "Test Audio Capture",
        "btn_open_extension": "Open Extension",
        ...
        "browser_not_authenticated": "Browser extension connected but not authenticated. Copy pairing token into popup.",
        "browser_no_tab": "No browser tab selected. Click on a tab in the extension popup.",
        "browser_user_action_required": "Action required: Complete capture permission prompt in the browser extension.",
        "browser_stale_tab": "Selected tab is from a previous session. Please reselect tab in extension.",
        "browser_heartbeat_expired": "Extension heartbeat timed out. Reopen the extension popup.",
        "browser_session_active": "Browser Tab Audio stream is active.",
    ...
    "de": {
        ...
        "btn_recheck_readiness": "Bereitschaft prüfen",
        "btn_test_capture": "Audio Capture testen",
        "btn_open_extension": "Erweiterung öffnen",
        ...
        "browser_not_authenticated": "Erweiterung verbunden, aber nicht authentifiziert. Kopplungstoken ins Popup einfügen.",
        "browser_no_tab": "Kein Tab ausgewählt. Bitte Tab im Browser-Popup anklicken.",
        "browser_user_action_required": "Benutzeraktion erforderlich: Bitte Freigabe im Browser-Popup bestätigen.",
        "browser_stale_tab": "Ausgewählter Tab stammt aus früherer Sitzung. Bitte erneut auswählen.",
        "browser_heartbeat_expired": "Verbindungs-Heartbeat abgelaufen. Bitte Erweiterungs-Popup erneut öffnen.",
        "browser_session_active": "Browser-Tab-Audiostream ist aktiv.",
